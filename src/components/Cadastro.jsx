...
import People from 'react-native-vector-icons/AntDesign';
...
export default props => {
    ...
    return (
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'white' }}>
            ...
            <View style={cadastro.name}>
                <Senha name='lock' size={30} color='#3D3B40' />
                <TextInput
                    onChangeText={value => setnome(value)}
                    placeholder="Senha"
                />
           ...
           <View style={cadastro.botoes}>
            ...
            <Text>Já tem conta? <Text  style={cadastro.login}>Faça Login!</Text></Text>
            </TouchableOpacity> 
